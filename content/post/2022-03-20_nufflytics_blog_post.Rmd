...
date: '2022-03-20'
summary: This blogpost is about **Blood Bowl**, a boardgame I started playing last year. 
The idea of this blog post is to showcase some possible analyses that can be done on the FUMBBL match data I've compiled.
...
The idea of this blog post is to showcase some possible analyses that can be done on the [FUMBBL match data I've compiled]((https://gsverhoeven.github.io/post/blood-bowl-fumbbl-dataset/). The idea is to make Blood Bowl data analysis (also know as [Nufflytics](https://nufflytics.com), in reference to Nuffle, the god of Blood Bowl) easier and more accessible to others. I took inspiration from various sources, detailed at the end of this post. So lets dive in the world of Blood Bowl stats nerdery.
