...
We have two additional cost drivers, the associated disk ("storage"), and we need to pay for a public IP address. 

* virtual machine (2.4 euro / day for a `Standard D2s_v3`) , 
* public IP address (0.1 euro / day for a static IPv4 address)
* SSD disk (0.1 euro / day)

If we would bring it up and keep it on for a whole day we pay around 2.5 euro a day.
