...
summary: "Restate my assumptions: If you graph the numbers of any system, patterns emerge. In this plot we'll use clustered heatmaps to graph the numbers from the Blood Bowl Fantasy football game, and see what patterns emerge!"
...
The blog post from Schlice [@schlice18a] makes heavy use of functional programming using R's `purrr` package. This allows us to write a function and have this function work in parallel on a list of objects, and have it return the results also in list form. 
