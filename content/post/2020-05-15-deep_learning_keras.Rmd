...
I followed the tutorial from Tensorflow to build from source on a Linux system (Ubuntu 18.04 LTS).
(https://www.tensorflow.org/install/source)
Therefore, these notes are most useful to other Linux users, and my future self of course.
...
* Install ["Bazel"](https://docs.bazel.build/versions/master/install-ubuntu.html#install-with-installer-ubuntu) (Google's Make program), version 3.1
* Clone the Tensorflow ["repository from GitHub"](https://github.com/tensorflow/tensorflow)
* Checkout the latest official TensorFlow release (v2.2)
