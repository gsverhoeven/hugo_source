...
Finally, we conclude that the nasal swabs are less sensitive than the nasopharyngeal ("deep nose") swabs, this reduces sensitivity by roughly 10%. The conclusion is based on my own weighting of the evidence (see above). This conclusion does not follow from the studies on the Roche kit (Lindner *et al.* 2021, Igloi *et al.* 2021), but I think those studies are consistent with it. 
