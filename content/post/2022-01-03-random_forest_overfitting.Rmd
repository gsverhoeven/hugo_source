...
The line segments display the sampling variation in the R-squared statistic as a 90% confidence interval, this interval was generated using 1000 bootstrapped values of R2 using the vectors of (out-of-bag) predictions and the observed y-values (This deserves its own future blog post, if you can't wait just check the `prep_and_fit.Rmd` notebook on my Github).
