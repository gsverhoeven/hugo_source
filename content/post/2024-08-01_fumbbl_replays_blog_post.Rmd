...
date: '2024-07-25'
summary: The **fumbbl_replays** package is a Python utility package for the board game Blood Bowl. It allows users to plot board positions, either from scratch, or from existing (FUMBBL) game logs. In addition, it has some functionality to analyze FUMBBL game logs for the board game Blood Bowl.
slug: fumbbl-replays
draft: no
categories: 
- Data science
